...
import { Code2, Crown, Search, Filter, BookOpen, Users, Star, Clock, ArrowRight, Map, Target, CheckCircle, Circle, Play, Menu } from "lucide-react";
  ...
  return (
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <Sidebar className="border-slate-700 bg-slate-900/95">
          ...
          <SidebarContent>
            <SidebarGroup>
              <SidebarGroupLabel className="text-slate-300 font-semibold">
                  ...
                  {roadmapSteps.map((step, index) => (
                    <div key={step.id} className="relative">
                      {index < roadmapSteps.length - 1 && (
                        <div className="absolute left-4 top-8 w-0.5 h-12 bg-slate-600"></div>
                      )}
                      
                      <div className={`flex items-start gap-3 p-3 rounded-lg border transition-all ${getStatusColor(step.status)} ${step.status !== 'locked' ? 'hover:bg-slate-700/50 cursor-pointer' : 'opacity-60'}`}>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-slate-400 mb-1">{step.description}</p>
            ...
            <SidebarGroup>
              ...
              <SidebarGroupContent>
                <div className="p-3 mx-2 bg-gradient-to-r from-blue-500/10 to-purple-600/10 rounded-lg border border-blue-500/20">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-400 mb-1">33%</div>
                    <div className="text-xs text-slate-300 mb-2">2 of 6 completed</div>
